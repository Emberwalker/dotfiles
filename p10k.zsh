# Generated by Powerlevel10k configuration wizard on 2021-08-17 at 10:29 BST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_K8S_VISUAL_IDENTIFIER_EXPANSION='⎈'
  typeset -g POWERLEVEL9K_DIR_K8S_BACKGROUND=27
  typeset -g POWERLEVEL9K_DIR_K8S_FOREGROUND=254
  typeset -g POWERLEVEL9K_DIR_K8S_SHORTENED_FOREGROUND=254
  typeset -g POWERLEVEL9K_DIR_K8S_ANCHOR_FOREGROUND=254

  typeset -g POWERLEVEL9K_DIR_DEV_VISUAL_IDENTIFIER_EXPANSION='⌬'
  typeset -g POWERLEVEL9K_DIR_DEV_BACKGROUND=214
  typeset -g POWERLEVEL9K_DIR_DEV_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_DEV_SHORTENED_FOREGROUND=0
  typeset -g POWERLEVEL9K_DIR_DEV_ANCHOR_FOREGROUND=0
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      (( $#branch > 64 )) && branch[32,-32]="…"  # <-- this line
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_BACKGROUND=38
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEV_VISUAL_IDENTIFIER_EXPANSION='⛵️'

  typeset -g POWERLEVEL9K_KUBECONTEXT_HERITAGE_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_HERITAGE_BACKGROUND=202
  typeset -g POWERLEVEL9K_KUBECONTEXT_HERITAGE_VISUAL_IDENTIFIER_EXPANSION='✈️ '
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CTRL_FOREGROUND=0
  typeset -g POWERLEVEL9K_KUBECONTEXT_CTRL_BACKGROUND=57
  typeset -g POWERLEVEL9K_KUBECONTEXT_CTRL_VISUAL_IDENTIFIER_EXPANSION='🚥'
